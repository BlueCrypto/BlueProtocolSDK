...
var blueSdkMessageEndpoint = 'https://scan.blueprotocol.com/v2/message';
/**
...
function () {
   ...
   * );
   */
  function BlueProtocolSdk(apiKey, address) {
  ...
  (0, _createClass2.default)(BlueProtocolSdk, [{
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regenerator.default.mark(function _callee(message, signedMessage) {
        var response;
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return fetch(blueSdkMessageEndpoint, {
                  headers: {
    ...
    key: "requestScanLists",
    value: function requestScanLists(address) {
      return {
        'action': 'scanLists',
        'arguments': {
          'address': address
    ...
    key: "requestAnalyzeContract",
    value: function requestAnalyzeContract(address) {
      return {
